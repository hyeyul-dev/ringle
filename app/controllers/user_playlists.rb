  ...
  resource :user_playlists do
    ...
    post do
      ...
      if params[:music_id].instance_of?(Integer)
        user_playlist.music_user_playlists.create!(music_id: music_id)
      else
    ...
    delete do
      if params[:music_id].instance_of?(Integer)
        UserMusicPlaylist.find_by(music_id: music_id, user_playlist_id: user_playlist.id)&.destroy
      else
        user_play_list.music_user_play_lists.where(music_id: params[:music_id]).destroy_all
      end
